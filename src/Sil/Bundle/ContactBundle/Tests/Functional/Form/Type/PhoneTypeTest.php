 ...
 *
 * @coversDefaultClass \Sil\Bundle\ContactBundle\Form\Type\PhoneType
 */
class PhoneTypeTest extends BlastTestCase
{
    /**
     * Form factory.
     *
    ...
    public function test_submit()
    {
        ...
        $standard = new Phone($formData['number']);
        $standard->setType($formData['type']);

        $form = $this->formFactory->create(PhoneType::class, []);
