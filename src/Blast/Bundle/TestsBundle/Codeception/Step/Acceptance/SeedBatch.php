...
class SeedBatch extends Lisem
{
    public function createPlot($producerName)
    {
        ...
        $this->amOnPage(getenv('SILURL') . '/sil/seedbatch/plot/create');
    ...
    public function createProducer()
    {
        ...
        $this->amOnPage(getenv('SILURL') . '/sil/seedbatch/seed-producer/create');
    ...
    public function createSeedBatch($varietyName, $producerName, $plotName)
    {
        ...
        $this->amOnPage(getenv('SILURL') . '/lisem/silseedbatchbundle-seedbatch/create');
