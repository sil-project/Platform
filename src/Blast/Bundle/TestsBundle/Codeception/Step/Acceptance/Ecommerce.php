...
class Ecommerce extends Lisem
{
    ...
    public function createChannel($channelName)
    {
        ...
        $this->amOnPage(constant('SILURL') . '/librinfo/ecommerce/channel/create');
    ...
    public function activeAccount($userLogin)
    {
        ...
        $this->amOnPage(constant('SILURL') . '/librinfo/ecommerce/shop_user/list');
    ...
    public function checkOrder($customerName)
    {
        ...
        $this->amOnPage(constant('SILURL') . '/librinfo/ecommerce/order/list');
