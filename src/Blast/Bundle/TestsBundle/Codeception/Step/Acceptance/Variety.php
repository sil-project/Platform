...
class Variety extends Lisem
{
    public function createVariety($speciesName, $plantCatName)
    {
        ...
        $this->amOnPage(getenv('SILURL') . '/sil/variety/create');
    ...
    public function createSpecies($genusName, $plantCatName)
    {
        ...
        $this->amOnPage(getenv('SILURL') . '/platform/silvarietybundle-species/create');
    ...
    public function createGenus($familyName)
    {
        ...
        $this->amOnPage(getenv('SILURL') . '/platform/silvarietybundle-genus/create');
    ...
    public function createFamily()
    {
        ...
        $this->amOnPage(getenv('SILURL') . '/platform/silvarietybundle-family/create');
    ...
    public function createPlantCategory()
    {
        ...
        $this->amOnPage(getenv('SILURL') . '/sil/variety/plantcategory/create');
