...
class Variety extends Lisem
{
    public function createVariety($speciesName, $plantCatName)
    {
        ...
        $this->amOnPage(constant('SILURL') . '/librinfo/variety/create');
    ...
    public function createSpecies($genusName, $plantCatName)
    {
        ...
        $this->amOnPage(constant('SILURL') . '/librinfo/varieties/species/create');
    ...
    public function createGenus($familyName)
    {
        ...
        $this->amOnPage(constant('SILURL') . '/librinfo/varieties/genus/create');
    ...
    public function createFamily()
    {
        ...
        $this->amOnPage(constant('SILURL') . '/librinfo/varieties/family/create');
    ...
    public function createPlantCategory()
    {
        ...
        $this->amOnPage(constant('SILURL') . '/librinfo/varieties/plantcategory/create');
